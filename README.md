...
- **Batch export** - Export multiple notes into a single document
- **Preserved structure** - Headings, lists, tables, and code blocks transfer cleanly
- **Real-time progress** - Watch as the AI builds your document section by section
...
│                               Backend (Rust)                                     │
│  ┌────────────┐ ┌────────────┐ ┌────────────┐ ┌────────────┐ ┌────────────────┐ │
│  │   SQLite   │ │  Tantivy   │ │ AI Gateway │ │  Calendar  │ │ Export Agent   │ │
│  │ + Vectors  │ │   Search   │ │  (Bifrost) │ │   Events   │ │ (PDF/DOCX/...) │ │
│  └────────────┘ └────────────┘ └────────────┘ └────────────┘ └────────────────┘ │
└─────────────────────────────────────────────────────────────────────────────────┘
```
